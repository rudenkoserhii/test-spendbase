...
export class Weather {
    ...
    @ApiProperty({ example: 123456789, description: 'Unique identifier of the weather record' })
    id: number;
    ...
    @Column()
    @ApiProperty({ example: 'current', description: 'Part of the weather data (e.g., current, hourly, daily)' })
    part?: WeatherPart;
    ...
    @ApiProperty({
        example: {
            ...
            main: { temp: 284.2, feels_like: 282.93, temp_min: 283.06, temp_max: 286.82 },
